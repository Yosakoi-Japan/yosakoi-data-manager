...
**Tests**: Verification tasks are REQUIRED. Every user story MUST include the
automated tests or fixture-based validation needed by the constitution.
...
- [ ] T010 Define module boundaries and shared naming conventions for the feature
...
- [ ] T013 [P] [US1] Fixture-based validation for [dataset/export] in tests/[location]/test_[name].py
...
- [ ] T019 [US1] Add logging or summary output for user story 1 operations
- [ ] T020 [US1] Refine names, split oversized logic, and document rerun command in quickstart.md
...
- [ ] T023 [P] [US2] Fixture-based validation for [dataset/export] in tests/[location]/test_[name].py
...
- [ ] T028 [US2] Document any new operator warnings, counts, safeguards, and
...
- [ ] T031 [P] [US3] Fixture-based validation for [dataset/export] in tests/[location]/test_[name].py
...
- [ ] T035 [US3] Confirm safe rerun behavior and document destructive edge
  cases or maintainability debt
...
- [ ] TXXX Review naming consistency, dead code, and module size across touched files
...
- Verification tasks MUST be written and FAIL before implementation
- Models before services
- Services before endpoints
- Core implementation before integration
- Refactoring for readability MUST happen before a story is considered complete
...
Task: "Fixture-based validation for [dataset/export] in tests/[location]/test_[name].py"
...
- Verify tests or validation checks fail before implementing
